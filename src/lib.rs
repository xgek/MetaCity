...
#[derive(Debug)]
pub struct MetaCityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaCityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaCity processing");
    
    let mut processor = MetaCityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaCityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaCityProcessor::new(false);
